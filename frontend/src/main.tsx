...
function Manual(){
  ...
  const steps=session.role==='ANALYST'
    ...
    :session.role==='ADMIN'
    ?['휴가 신청 입력에서 정기 휴가 신청서를 접수합니다.','워크플로우가 잔여 휴가와 관련 부대 일정을 조회하고 AI 승인 요약을 생성합니다.','실행 모니터링에서 신청 내용과 근거를 확인한 뒤 승인하거나 반려합니다.','승인하면 결과가 모의 부대 인트라넷에 등록됩니다.','에이전트 채팅에서 “이번 주차 외출/외박 현황 보고 작성해줘”를 실행합니다.']
