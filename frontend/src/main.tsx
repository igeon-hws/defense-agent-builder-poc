...
function SituationMap({commanderHome=false}:{commanderHome?:boolean}){
  ...
  const commanderDefaultAgent=commanderAgents.find(agent=>agent.system_default&&agent.default_kind==='GENERAL')||commanderAgents[0];
  return <>
    ...
    {commanderHome&&session&&commanderDefaultAgent&&<ReactAgentChat session={session} agentId={commanderDefaultAgent.id} embedded/>}
